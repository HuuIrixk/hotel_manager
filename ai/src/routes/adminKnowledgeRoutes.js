...
// Chỉ cho backend admin gọi, qua header x-ai-admin-secret
...
// GET /admin/kb
// Trả danh sách doc group theo (title, source)
...
router.post('/', async (req, res) => {
  ...
  try {
    ...
    for (let i = 0; i < chunks.length; i++) {
      ...
      await query(insertSql, [title, effectiveSource, i, chunkText, literal]);
      count++;
    }
